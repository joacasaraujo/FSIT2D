...
int main() {
    ...
    S.dem_coupling       = "IMB";
    // S.SetRelaxationParamters(0, 1.4, 1.4, 0, 1.2, 0, 1.2, 1.0 / S.relaxation_time, 1.0 / S.relaxation_time);
    double s8 = 2/(1 + 6*nu);
    ...
    S.addDiskPacking(Rmin, Rmax, wall_gap, inlet_buf, outlet_buf, non_overlap, max_particles, wall_particles, rho_p, Rw_min, Rw_max);
